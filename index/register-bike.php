...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table width="978" border="0" align="center" cellpadding="0" cellspacing="0" background="<?php echo $path; ?>images/hdbg.png">
      <tr>
        <td width="130" height="130" align="left"><a href="index.php"><img src="<?php echo $path; ?>images/logo.jpg" alt="Lion Cycle Store" width="130" height="130" border="0" /></a></td>
          	...
          	<td>
            	<table width="0" cellpadding="0" cellspacing="0" align="center" border="0">
					...
					?>
                      ...
                      <!--<td><a href="gallery.html" class="menu">Bike</a></td>
  ...
  <?php
	...
	if($menu_name=='Home' && empty($_GET['news_id']))
	{
  ?>
  <tr>
        ...
        <td height="400">
        	<!-- #gallery -->
              <section id="gallery">
                <div class="container">
                    <ul id="myRoundabout">
                    <li><img src="<?php echo $path; ?>images/s7.jpg" alt=""></li>
                    <li><img src="<?php echo $path; ?>images/s6.jpg" alt=""></li>
                    <li><img src="<?php echo $path; ?>images/s5.jpg" alt=""></li>
                    <li><img src="<?php echo $path; ?>images/s1.jpg" alt=""></li>
                    <li><img src="<?php echo $path; ?>images/s4.jpg" alt=""></li>
                  </ul>
                </div>
              </section>
              <!-- /#gallery -->        </td>
  ...
  <tr>
    <td align="center"><table width="978" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><span class="style1">© 1995 - 2012 Lion Cycle Corporation. All rights reserved.</span></td>
      </tr>
    </table></td>
  </tr>
  <tr>
