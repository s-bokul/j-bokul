		  ...
		  <table width="978" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="978" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="25"><strong>Add Photo</strong> </td>
                </tr>
                <tr>
                  <td><form action="photo_ins.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    <table width="978" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="30" align="left" valign="middle">Title : </td>
                        <td align="left" valign="middle"><input name="title" type="text" id="title" size="30" /></td>
                      </tr>
                      <tr>
                        <td width="116" height="30" align="left" valign="middle">Upload Pictire : </td>
                        <td width="862" align="left" valign="middle">
							<input name="photo" type="file" id="photo" />
						  <input name="album_id" type="hidden" id="album_id" value="<?php echo $_GET['id']; ?>" />						</td>
                      </tr>
                        <tr>
                            <td height="30" align="left" valign="middle">Web URL : </td>
                            <td align="left" valign="middle"><input name="web_url" type="text" id="web_url" size="30" /></td>
                        </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="middle"><textarea name="description" id="description" rows="18"></textarea></td>
                      </tr>
